        <p>You are about to sell the stock below. Please check everything to make sure it is correct.</p>
        <table class="table">
                        <tr class="table-title-row"><td>Stock Symbol</td><td>Shares</td><td>Current Price</td></tr>
                        <tr class="table-row"><td><?php echo($stock["symbol"])?></td>
        ...
        <p>After clicking "I agree" this action cannot be undone.</p>
            <div class="form-group">
                    ...
                    <button type="submit" name="sell" class="btn btn-default">I agree</button>
                </div>
            </fieldset>
        </form>
